...
in buildGoModule {
  ...
  # https://github.com/tektoncd/cli/releases/tag/v0.17.0
  # nix-prefetch-url --unpack https://github.com/tektoncd/cli/archive/v0.17.0.tar.gz
  src = fetchFromGitHub {
    owner = "tektoncd";
    repo = "cli";
    rev = "v${version}";
  ...
  # https://github.com/tektoncd/cli/blob/v0.17.0/.goreleaser.yml#L18
  buildFlagsArray = [
